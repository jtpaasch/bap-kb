...
To represent a sequence of two statements, we will generate a string `(STMNT1 STMNT2)`, where we replace `STMNT1` and `STMNT2` with the strings we have alerady generated for the two statements:
